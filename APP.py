...
class App(tk.Tk):
    def __init__(self):
        ...
        ##########################PARA EL MENU########################
        self.menu_button = tk.Button(self.Inicio_frame, text="Menú", command=self.show_menu,width=10)
    ...
    def update_video(self):
        ...
        if not ret:
            self.image = ImageTk.PhotoImage(Image.open("descampado.jpg").resize((850, 480)))
